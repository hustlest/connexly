...
interface GlobeProps {
  ...
  // Off by default — marker labels assert specific real-world locations,
  // which should only be enabled with verified data.
  showLabels?: boolean;
}
...
export function InteractiveGlobe({
  ...
  }, [dotColor, arcColor, markerColor, autoRotateSpeed, connections, markers, showLabels]);
